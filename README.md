...
提供 clone 学习交流
 ...
 4.1富文本编辑器代码高亮问题的解决方案
	1.	在Gemfile里面加入一行gem 'simditor'
	2.	bundle install安装这个simditor这个gem，已经打包好所有simditor需要用的assets了
	3.	在application.js里面加上： js //= require simditor //= require simditor/simditor-fullscreen 注：我还加了一个simditor-fullscreen的插件，使      用esc切换全屏，方法专 注于写作
